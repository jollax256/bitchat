...
@main
struct NupChatApp: App {
    static let bundleID = Bundle.main.bundleIdentifier ?? "chat.nupchat"
    ...
    private func handleURL(_ url: URL) {
        if url.scheme == "nupchat" && url.host == "share" {
    ...
    private func checkForSharedContent() {
        ...
        guard let userDefaults = UserDefaults(suiteName: NupChatApp.groupID) else {
            return
        }
